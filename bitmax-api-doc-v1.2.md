...
Note: It is highly recommended to use [V2 version](https://bitmax-exchange.github.io/BitMax-API-v2/#get-deposit-address-of-one-asset) of this route, especially for assets with multiple block chians such as USDT. 
